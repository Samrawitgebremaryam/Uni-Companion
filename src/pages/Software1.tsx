...
import Component7Variant from "../components/Component7Variant";
import GroupComponent from "../components/GroupComponent";
import styles from "./Software1.module.css";

const Software1: FunctionComponent = () => {
  return (
    <div className={styles.software2}>
      ...
      <section className={styles.software2Inner}>
        <div className={styles.yearTitleParent}>
          ...
          <div className={styles.firstSemester}>
            <div className={styles.semesterTitle}>
              ...
              <div className={styles.semesterContent}>
                <div className={styles.semesterDetails}>
                  <Component7Variant propLeft="0px" propTop="0px" />
      ...
      <div className={styles.software2Child} />
      <GroupComponent />
    </div>
  );
};
